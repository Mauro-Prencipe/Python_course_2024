...
class Data(Stat):
    ...
    def get_dataset(cls):
        ...
        region_dictionary=dict(zip(cls.region_names, number_list))
        l_set=list(eval(iset) for iset in cls.region_names)
        return region_dictionary, np.array(l_set, dtype='object')
